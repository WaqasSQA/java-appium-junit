...
public class loginRepo {
    ...
    public WebElement loginSelectBtn;
    ...
    public loginRepo (AndroidDriver tempDriver){
        ...
        public void loginCreds(String phoneNumber, String password){
        enterPhoneNum(phoneNumber);
